...
class favoritePage extends StatefulWidget {
  final List<GridItem> gridItemFavoriteArray;
  favoritePage(this.gridItemFavoriteArray);
  @override
  _favoritePageState createState() => _favoritePageState(gridItemFavoriteArray);
}

class _favoritePageState extends State<favoritePage> {

  final List<GridItem> gridItemFavoriteArray;
  _favoritePageState(this.gridItemFavoriteArray);
    ...
    return Scaffold(
        ...
        body: GridView.count(
            ...
            children: List.generate(
              gridItemFavoriteArray.length,
                  (index) => ItemGrid(gridItemFavoriteArray[index]),
            ))
    );
  }
